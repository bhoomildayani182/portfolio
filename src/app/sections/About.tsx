      ...
      >
        <motion.div variants={itemVariants} className="mb-12">
          ...
          <div className="flex items-center gap-3 text-2xl text-gray-400">
            <span className="h-0.5 w-12 bg-secondary/50 rounded-full"></span>
            <span className="font-light">DevOps Engineer</span>
          </div>
        </motion.div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-8">
            <div className="glass p-8 rounded-3xl relative overflow-hidden group">
              ...
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                <p>
                  I am a passionate and goal-oriented <strong className="text-white">DevOps Engineer</strong> with over <strong className="text-white">1.5 years of experience</strong> designing robust CI/CD pipelines, orchestrating cloud infrastructure on AWS and Azure, and automating complex workflows.
                </p>
                <p>
                  My expertise lies in building high-availability architectures using tools like <strong className="text-primary-light">Terraform, Docker, Kubernetes, Jenkins, and Ansible</strong>. I thrive on solving scalability challenges and optimizing deployment efficiency.
                </p>
                <p>
                  Driven by a commitment to operational excellence, I focus on enhancing software quality, security, and performance through modern automation practices.
                </p>
              </div>
